...
const TABLE_HEAD = [
  ...
  { id: 'role', label: 'Mentor', alignRight: false },
  { id: 'company', label: 'Fecha', alignRight: false },
...
export default function Mentoring() {
  ...
  const baseUrl  = 'https://api.lessin.pe/wp-json/wp/v2/mentorias?per_page=100';
  const getCursos = ()=>{
  ...
  const eliminarCurso=(id) =>{
    axios.delete('https://api.lessin.pe/wp-json/wp/v2/mentorias/'+id,
    {
      headers: {
  ...
  const editRedirect = (id) =>{
    navigate(`/dashboard/mentoring/edit-mentoring/${id}`);
  }
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button 
            ...
            to={'/dashboard/mentoring/new-mentoring'}
          >
            Nuevo Mentoria
          </Button>
        </Stack>
                  ...
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{acf.m_mentor}</TableCell>
