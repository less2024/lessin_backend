...
export default function NewCourse() {
  ...
  const getDocentes  = async () =>{
    console.log('getttt  docentes');
    await axios.get(urlDocentes).then((data)=>{
  ...
  const getCategorias = async () =>{
    await axios.get(urlCategorias).then((data)=>{
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={12} md={9}>
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                  <Typography variant="h4" gutterBottom onClick={()=>console.log(temario)}>
                    Temario
                  </Typography>
                  <Button 
                    variant="contained" 
                      ...
                      :
                        <Card>
                          ...
                          <CardHeader
                            ...
                            title={cursoImageList.videoPreviewName}
                      ...
                      :
                        <Card>
                          ...
                          <CardHeader
                            ...
                            title={cursoImageList.catalogoPreviewName}
                            subheader="Video Preview"
                            sx={{ p: 2}}
                          />
                        </Card>
            ...
            <Card sx={{ mb: 3,zIndex:9 ,overflow:'visible'}}>
              <CardContent>
                <Typography variant="h4" gutterBottom onClick={()=>{console.log(postCurso.fProfesorDescripcion)}}>
                  Docente
                </Typography>
                <Stack direction="row" alignItems="center"  justifyContent="space-between" mt={3}>
                  <Grid container spacing={3}>
                ...
                <Stack direction="row" alignItems="center"  justifyContent="space-between" mt={3}>
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={12} md={4}>
                      {docenteImagen.docenteImagen === null?
                        <Button
                          component="label"
                          fullWidth
                          variant="outlined"
                        ...
                        >
                          ...
                          <input 
                            ...
                            hidden 
                            value={null}
                            onChange={()=>changeDocenteImagen(event)} 
                          />
                        </Button>
                      :
                        <Card>
                          <CardMedia
                            component="img"
                            height="194"
                            image={docenteImagen.docenteImagen}
                          >
                          </CardMedia>
                          <CardHeader
                            action={
                              <IconButton aria-label="settings" onClick={()=>{removeDocenteImagen()}}>
                                <DeleteIcon />
                              </IconButton>
                            }
                            title={docenteImagen.docenteImagenName}
                            subheader="Foto"
                            sx={{ p: 2}}
                          />
                        </Card>
                    ...
                    <Grid item xs={12} sm={12} md={8}>
                      <TextField id="outlined-basic" fullWidth label="Nombre"  onChange={changePostCurso} value={postCurso.fProfesor} name="fProfesor" variant="outlined" />
                    </Grid>
                    <Grid item xs={12} sm={12} md={12}>
                      <TextField id="outlined-basic" fullWidth label="Descripcion"  onChange={changePostCurso} value={postCurso.fProfesorDescripcion} name="fProfesorDescripcion" variant="outlined" />
                    </Grid>
                  </Grid>
                </Stack>
                }
              ...
              <CardContent>
                ...
                <FormGroup onChange={changeCategria}>
                  {categoriasList.map((item) => {
                    ...
                    return (
                      <FormControlLabel value={item.term_id} control={<Checkbox />} label={item.name} />
                    );
                  })}
                </FormGroup>
                }
